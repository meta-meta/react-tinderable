...
var Tinderable = React.createClass({displayName: "Tinderable",
    ...
    onSwipeLeft: function (triggeredExternally) {
        setTimeout(this.props.onSwipeLeft.bind(null, triggeredExternally), this.props.animationLength); // animation length for card to flick off screen
    },

    onSwipeRight: function (triggeredExternally) {
        setTimeout(this.props.onSwipeRight.bind(null, triggeredExternally), this.props.animationLength); // animation length for card to flick off screen
    },
